...
+ (NSBezierPath *) arrowForFrame: (NSRect)containingFrame withSize: (NSSize)size
{
	...
	[arrow relativeLineToPoint: NSMakePoint(w * 0.25,	h * 0.0f)];
	[arrow relativeLineToPoint: NSMakePoint(w * 0.0,	h * 0.5)];
	[arrow relativeLineToPoint: NSMakePoint(w * 0.5,	h * 0.0)];
	[arrow relativeLineToPoint: NSMakePoint(w * 0.0,	h * -0.5)];
	[arrow relativeLineToPoint: NSMakePoint(w * 0.25,	h * 0.0)];
	[arrow closePath];
